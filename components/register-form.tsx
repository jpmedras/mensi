          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <label htmlFor="password" className="flex items-center text-sm font-medium text-gray-700 mb-2">
                  ...
                  <div className="relative ml-2">
                    <button
                      ...
                      className="text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-800 rounded-full"
            ...
            <div className="text-center pt-4">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full max-w-xs bg-cyan-800 hover:bg-cyan-900 disabled:bg-cyan-600 text-white py-3 px-8 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-800 focus:ring-offset-2"
              >
      ...
      >
        <div className="text-center">
          ...
          <button
            ...
            className="w-full bg-cyan-800 hover:bg-cyan-900 text-white py-3 px-4 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-800 focus:ring-offset-2"
          >
