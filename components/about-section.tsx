  ...
  return (
    <section id="sobre-nos" className="bg-gray-100 py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12">O que é a Mensi?</h2>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="lg:w-2/3 space-y-6">
            ...
            <div className="pt-4 text-center md:text-left">
              <Link
                href="/register"
                className="inline-block bg-cyan-800 hover:bg-cyan-900 text-white px-6 py-3 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-800 focus:ring-offset-2"
              >
                Crie sua conta
              </Link>
            </div>
