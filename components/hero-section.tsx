        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-2/3 space-y-6">
            ...
            <div className="pt-4 text-center md:text-left">
              <Link
                href="/login"
                className="inline-block bg-cyan-800 hover:bg-cyan-900 text-white px-8 py-3 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-800 focus:ring-offset-2"
              >
                Começar agora
              </Link>
            </div>
